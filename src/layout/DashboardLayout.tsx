        ...
        <header className="h-20 bg-white/80 backdrop-blur-md flex items-center justify-between px-10 sticky top-0 z-10">
          ...
          <div className="flex items-center gap-3">
            <div className="text-right">
              <p className="text-xs font-bold text-gray-800 leading-none">Zahra</p>
              <p className="text-[9px] text-gray-400 mt-1">Administrator</p>
            </div>
            <div className="w-9 h-9 rounded-full bg-[#7A1C3D] flex items-center justify-center text-white text-[11px] font-bold ring-2 ring-rose-50">
              Z
            </div>
          </div>
        </header>

        {/* Konten dari Dashboard.tsx akan muncul di sini */}
        <main className="p-10">
          <Outlet /> 
        </main>
      </div>
